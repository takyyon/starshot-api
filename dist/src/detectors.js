 ...
 */
function inspect(projectRootUrl, framewokDefinitions = [], matchAll = false, projectFiles = []) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (projectFiles.length === 0) {
            projectFiles = yield (0, utils_1.loadProjectFiles)(projectRootUrl);
        }
        ...
        for (const framework of framewokDefinitions) {
            for (let fileUrl of projectFiles) {
                const frameworkMatchByPackageJson = yield inspectByPackageJSONIfExists(framework, projectRootUrl, fileUrl);
                if (frameworkMatchByPackageJson) {
                    foundFrameworks = insertOrUpdateMatchedFramwork(yield getMatchedFrameworkObject(projectRootUrl, framework, fileUrl), foundFrameworks);
                }
                const frameworkMatchByConfigurationFiles = yield inspectByConfigurationFileIfExists(framework, projectRootUrl, fileUrl);
                if (frameworkMatchByConfigurationFiles) {
                    foundFrameworks = insertOrUpdateMatchedFramwork(yield getMatchedFrameworkObject(projectRootUrl, framework, fileUrl), foundFrameworks);
                }
                const frameworkMatchByIndexHtml = yield inspectByIndexHtml(framework, projectRootUrl, fileUrl);
                    ...
                    if ((_a = framework.variant) === null || _a === void 0 ? void 0 : _a.length) {
                        ...
                        for (const variant of framework.variant) {
                            ...
                            if (variantFrameworkDefinition) {
                                ...
                                const foundVariantFramrworks = yield inspect(projectRootUrl, [variantFrameworkDefinition], matchAll, projectFiles);
                                foundFrameworks = insertOrUpdateMatchedFramwork(yield getMatchedFrameworkObject(projectRootUrl, framework, fileUrl), [
                                    ...foundFrameworks,
...
function inspectByPackageJSONIfExists(framework, root, fileUrl) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const jsonContentRaw = yield (0, utils_1.readFile)(fileUrl);
...
function inspectByConfigurationFileIfExists(framework, root, fileUrl) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const outputPath = yield evaluateOutputLocation(framework, root);
        if (outputPath === null) {
            return null;
        }
        ...
        if ((_a = framework.package) === null || _a === void 0 ? void 0 : _a.dependencies) {
            for (const dependencie of (_b = framework.package) === null || _b === void 0 ? void 0 : _b.dependencies) {
                ...
                const configurationFileContent = yield (0, utils_1.readFile)(fileUrl);
...
function hasConfigurationFiles(framework, filename) {
    if (!framework.configFiles)
        return false;
    let matchedFiles = 0;
    for (let configFile of framework.configFiles) {
...
function evaluateOutputLocation(framework, root) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const jsonContentRaw = yield (0, utils_1.readFile)(jsonFileToParsePath);
        if (jsonContentRaw) {
            if ((0, utils_1.isValidJson)(jsonContentRaw)) {
                const jsonContent = (0, utils_1.safeParseJson)(jsonContentRaw);
                const outputLocation = (yield (0, utils_1.jmespathSearch)(jsonContent, jmespathExpression.trim())) || "./";
...
function getMatchedFrameworkObject(projectRootUrl, framework, filepath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return {
            ...
            deployment: {
                appLocation,
                outputLocation: yield evaluateOutputLocation(framework, projectRootUrl),
            },
